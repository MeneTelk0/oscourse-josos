...
int mon_info(int argc, char **argv, struct Trapframe *tf);
...
static struct Command commands[] = {
        ...
        {"info", "Display info for testing", mon_info},
};
...
int
mon_info(int argc, char **argv, struct Trapframe *tf) {
    cprintf("Here is some info\n");
    return 0;
}
